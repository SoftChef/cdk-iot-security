...
## class JitpRole  <a id="softchef-cdk-iot-security-jitprole"></a>
...
```ts
new JitpRole(scope: Construct, id: string)
```
...
**jitpRole** | <code>[JitpRole](#softchef-cdk-iot-security-jitprole)</code> | <span></span>
